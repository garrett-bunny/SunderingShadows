...
void create() 
{
    ...
    set_long("%^RESET%^This orcish guard wears a dull suit of %^BOLD%^%^WHITE%^silver chain mail%^RESET%^ and carries a trident at ready.  This creature is obviously very unkempt, hygiene is not a term that applies to it.  Its skin is a sickly gray and its course hair is matted together with all types of filth.  This guard is one of the elite of this keep, to boast his position he wears a %^BOLD%^%^WHITE%^bone%^RESET%^ ring.%^RESET%^");
