...
void create() 
{
    ...
    set_long("%^RESET%^This orcish guard wears a dull suit of %^BOLD%^%^WHITE%^silver chain mail%^RESET%^ and carries " + ob->query_short() + " at ready.  This creature is obviously very unkempt, hygiene is not a term that applies to it.  Its skin is a sickly gray and its course hair is matted together with all types of filth.  It patrols this keep, but how effective of a patrol that is remains to be seen.%^RESET%^");
    ob->move(TO);
