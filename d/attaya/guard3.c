...
void create(){
    ...
    set_long("You have come to a hidden altar.  This is a circular chamber with stained glass walls!  Bright lights glow behind the walls and beneath the floor where they shine through a glass symbol of the Kinnesaruda. A kneeling block lies at the center of the room and a sacrificial table sits at either side.  The ceiling in here is wavering as if a pocket of intense heat were between you and it. You can feel the angry glare of a powerful evil presence upon you. %^BOLD%^%^BLUE%^A Mysterious Portal is here.");
    set_items(([
        "ceiling" : "The ceiling seems to be unstable, some unseen force lies between you and it, or perhaps reality is warped.",
        "altar" : "This is an altar dedicated to resurrecting the dead.  It is a holy place for the most malevolent forces imaginable.",
...
void reset(){
    ::reset();
    if(!present("ashtar")) new("/d/attaya/mon/ashtar")->move(this_object());
    stormed = 0;
}
