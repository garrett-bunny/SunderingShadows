...
"You are standing on Sunset Way, which leads east back to the Offestry town square and continues west a little further. The cobblestone %^ORANGE%^streets %^RESET%^are smooth beneath your feet, granting passage to the light but "
"steady stream of %^CYAN%^traffic %^RESET%^that passes through the town on a daily basis.  The street is bordered on both "
"sides by a jumble of %^RED%^buildings%^RESET%^. To the north the closest of which is a weapon smith with its doors open to welcome customers. "
"To the south the closest of which is the tavern with its doors open to welcome customers.%^RESET%^\n");
...
"travelers.  Sunset Way trails east, back towards the square which serves as the heart of this town.  West, it "
...
"varied styles give a unique appearance to the cozy town around you, where no two buildings are the same.  Nearest is the "
"weapon shop and the tavern.%^RESET%^",
   ]));
   set_exits(([
      "west":MAINTOWN"wstreet3",
      "east":MAINTOWN"wstreet1",
      "north":MAINTOWN"weapon",
      "south":MAINTOWN"wbar",
   ]));
}
