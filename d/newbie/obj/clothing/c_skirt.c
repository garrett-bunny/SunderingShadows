...
void create_skirt()
{
   ...
   switch(val) {
      case 0..5:
         FABRIC = "burlap";
         set_long("This is a rough and rather crude "+LENGTH+" "+
      ...
      case 6..10:
         FABRIC = "hemp";
         set_long("This "+LENGTH+" skirt is made out of light "+
      ...
      case 11..15:
         FABRIC = "cotton";
         set_long("The "+LENGTH+" cotton skirt is light and soft. It's"+
      ...
      case 31..34:
         FABRIC = "silk";
         set_long("The "+LENGTH+" silk skirt is beautiful and ever so"+
      ...
      case 35..39:
         FABRIC = "chiffon";
         set_long("This extraordinary "+LENGTH+" skirt is made of "+
   ...
   set_name("dress");
   set_type("ring"); //changed to ring to allow them to be worn 
//with pouches.  ~Circe~ 4/29/05
   set_limbs(({"waist"}));
   set_weight(3);
   set_short("%^RESET%^A "+LENGTH+" %^RESET%^"+str+"%^RESET%^ "+FABRIC+" skirt");
   set_id(({"skirt","clothing",""+str+" skirt%^RESET%^",""+FABRIC+" skirt",""+str+" "+FABRIC+" skirt%^RESET%^",""+LENGTH+" "+str+" skirt%^RESET%^",""+LENGTH+" skirt",""+LENGTH+" "+FABRIC+" skirt",""+LENGTH+" "+str+" "+FABRIC+" skirt%^RESET%^"}));
}
