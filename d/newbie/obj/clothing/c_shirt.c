...
void create_shirt()
{
   ...
   switch(val) {
      case 0..5:
         FABRIC = "burlap";
         set_long("This is a rather rough and uncomfortable "+LENGTH+""+
      ...
      case 6..10:
         FABRIC = "hemp";
         set_long("This "+LENGTH+" shirt is made out of sturdy"+
      ...
      case 11..15:
         FABRIC = "cotton";
         set_long("This is a soft, "+LENGTH+" cotton shirt that has"+
      ...
      case 16..20:
         FABRIC = "woolen";
         set_long("This is a hand-knit "+LENGTH+" woolen shirt that has"+
      ...
      case 21..25:
         FABRIC = "fleece";
         set_long("This "+LENGTH+" fleece shirt is just about the"+
      ...
      case 26..30:
         FABRIC = "suede";
         set_long("This "+LENGTH+" suede shirt has been dyed "+VAR+""+
      ...
      case 31..35:
         FABRIC = "velvet";
         set_long("The velvet shirt is very soft and quite pleasant"+
      ...
      case 36..39:
         FABRIC = "silk";
         set_long("This is a delicate "+LENGTH+" silk shirt that has"+
   ...
   set_limbs(({"torso"}));
   set_weight(3);
 set_short(capitalize(VAR)+" "+str+"%^RESET%^ "+LENGTH+" "+FABRIC+" shirt%^RESET%^");
   set_id(({"shirt","clothing",""+str+" shirt",""+FABRIC+" shirt",""+str+" "+FABRIC+" shirt",""+LENGTH+" shirt",""+LENGTH+" "+FABRIC+" shirt",""+LENGTH+" "+str+" shirt",""+LENGTH+" "+str+" "+FABRIC+" shirt",""+str+" "+LENGTH+" "+FABRIC+" shirt",""+str+" "+LENGTH+" shirt"}));
}
