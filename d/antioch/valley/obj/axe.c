...
void create()
{
	...
	set_lore("The Axe of Bramble and Thorns was a common "+
		"weapon seen on a band of rangers devoted to nature,"+
		" named the Thorns of Nature.  Taking a more severe "+
		...
		" of ancient god of the beast.  The Axe of Bramble and Thorns was seen as a "+
