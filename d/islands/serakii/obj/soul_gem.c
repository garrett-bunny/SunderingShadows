...
void create(){
	...
	set_id(({ "shard", "shard of soul", "glowing yellow gem", "yellow gem", "gem"}));
	set_short("%^C226%^gl%^C228%^o%^C226%^wi%^C192%^n%^C226%^g %^C229%^y%^C226%^ell%^C192%^o%^C226%^w %^C192%^g%^C226%^em%^CRST%^");
