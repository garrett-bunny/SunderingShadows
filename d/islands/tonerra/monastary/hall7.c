...
OLI
   ...
   set_exits(([
      "north":MONASTERY+"hall8",
      "south":MONASTERY+"hall6"
      ]));
...
int pull(string str){
   ...
   tell_room(TO,"Your hear a slight grinding as something seems to slide to the west.\n The hanging on that wall flutters a little as air seems to flow.");

   add_exit(MONASTERY+"stairs4","west");
