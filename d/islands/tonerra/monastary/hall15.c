...
set_listen("default","Your heavy footsteps echo no matter how carefully you walk.");
   ...
   set_exits(([
      "north":MONASTERY+"hall16",
      "south":MONASTERY+"hall14"
      ]));
...
int pull(string str){
   ...
   tell_room(TO,"Your hear a slight grinding as something seems to slide to the east.\n The hanging on that wall flutters a little as air seems to flow.");

   add_exit(MONASTERY+"stairs3","east");
