...
the northwest. Your footsteps echo in the walk way. Worn %^MAGENTA%^tapestries%^WHITE%^
...
OLI
   ...
   set_exits(([
      "northwest":MONASTERY+"hall10",
      "southeast":MONASTERY+"entrance"
      ]));
...
int pull(string str){
   ...
   tell_room(TO,"Your hear a slight grinding as something seems to slide to the southwest.\n The hanging on that wall flutters a little as air seems to flow.");

   add_exit(MONASTERY+"stairs2","southwest");
