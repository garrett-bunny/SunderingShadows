...
void create()
{
    ...
    set_obvious_short("%^BOLD%^%^WHITE%^A s%^RESET%^i%^BOLD%^lv%^RESET%^e%^BOLD%^r circlet adorned with a %^BOLD%^%^BLUE%^bl%^RESET%^%^BLUE%^u%^BOLD%^%^BLUE%^e g%^RESET%^%^BLUE%^e%^BOLD%^%^BLUE%^m%^RESET%^");
...
int wear_func(){
    ...
    tell_object(player, "%^RESET%^%^BOLD%^The %^BLUE%^gem %^WHITE%^on the silver circlet begins to softly %^CYAN%^glow %^WHITE%^as you place it upon your brow.%^RESET%^");
    tell_room(room, "%^RESET%^%^BOLD%^The %^BLUE%^gem %^WHITE%^on "+player->query_cap_name()+"%^RESET%^%^BOLD%^'s silver circlet begins to %^CYAN%^glow %^WHITE%^as "+player->query_subjective()+" places it upon "+player->query_possessive()+" brow.%^RESET%^", player);
    return 1;
}
...
int remove_func(){
    ...
    tell_object(ETO, "%^RESET%^%^BOLD%^The %^BLUE%^gem %^WHITE%^on the silver circlet stops %^CYAN%^glowing %^WHITE%^as you remove it from your brow.%^RESET%^");
    tell_room(EETO, "%^RESET%^%^BOLD%^The %^BLUE%^gem %^WHITE%^on "+player->query_cap_name()+"%^RESET%^%^BOLD%^'s silver circlet stops %^CYAN%^glowing %^WHITE%^as "+player->query_subjective()+" removes it from "+player->query_possessive()+" brow.%^RESET%^", player);
    return 1;
}
