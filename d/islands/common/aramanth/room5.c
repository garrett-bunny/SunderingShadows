...
");
   set_listen("default", "The waves crashing against the beach far below carries over the plateau and echoes off the walls.");
    ...
    "footprints" : "They start at the ladder and lead away south.",
...
void reset(){
   ::reset();
      if(!present("obelisk")) {
      new("/d/islands/common/obj/obelisk1")->move(this_object());
      }
}
