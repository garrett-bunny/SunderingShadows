...
void create() {
   ::create();
   set("long",
      "%^RESET%^%^GREEN%^This part of the trail is covered in plant life from the forest as if it is more"+
   ...
   set_items( ([
      "grass":"Between the thick of the forest and the path, there are several feet of tall grass." 
   ]) );
   set_exits( ([
