...
void create(){
    ...
    set_long("%^%^BOLD%^%^RED%^This once small and cozy inn has been nearly brought to the ground in ruins. Pieces of roof have collapsed in and the walls are buckled and collapsing.");
