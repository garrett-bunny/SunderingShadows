...
void create()
{
   ...
   "The road stretches out to the north and southeast, running along the"+
   ...
   set_exits(([
   "north" : FORESTDIR+"road35",
   "southeast" : FORESTDIR+"road37",
   "west" : MEADOWS+"meadow16",
   "east" : MEADOWS+"meadow17",
   ]));
}
