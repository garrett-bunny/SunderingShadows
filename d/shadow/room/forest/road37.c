...
void create()
{
   ...
   "The road stretches out to the northwest and east, running along the"+
   ...
   set_exits(([
   "northwest" : FORESTDIR+"road36",
   "east" : FORESTDIR+"road38",
   "north" : MEADOWS+"meadow17",
   "south" : MEADOWS+"meadow20",
   ]));
}
