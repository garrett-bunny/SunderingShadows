...
void create()
{
   ...
   "The road stretches out to the north and east here. To the north"+
   " you can see the meadowlands. The brush grows higher further east.\n"
   );
   ...
   set_exits(([
   "north" : FORESTDIR+"road41",
   "east" : FORESTDIR+"road43",
   ]));
}
