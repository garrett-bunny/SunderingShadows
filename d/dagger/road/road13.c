...
void create(){
   ...
   set_travel(DIRT_ROAD);
    ...
    set_long(
      "%^CYAN%^You are on the dagger seacoast road just northeast of the bridge, visible to the southwest crossing the river Shelk.  To your east you can see the golden beaches as they line the seacoast below the ridge you are on.  To the northwest is the great Yniam plains, and to the northeast you can make out the spires above the seaport of Torm."
    );
	...
	"torm" : "The seaport of Torm, known for its fine inns, fresh seafood and good rum.", 
      ]) );
    set_exits( ([
