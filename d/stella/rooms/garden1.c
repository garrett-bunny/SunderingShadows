...
void reset(){
    ...
    guarded = 1;
    attempted = 0;
    if (!present("statue")) new(OPATH "unicorn")->move(TO);
}
...
void create(){
    ...
    set_long(
      ...
      "To the south, you see the entrance to the castle gardens.  "
      "To the north, you can see the front gate of the castle."
    );
    set_listen("default",
    ...
    set_exits(([
	"south": RPATH "path1",
	"northeast": RPATH "garden2",
	"northwest": RPATH "garden8",
	"gate": RPATH "tower1"
      ]));
}
