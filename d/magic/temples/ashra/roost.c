...
void create()
{
    ...
    set_items(([
        ...
        ({"armor display"}) : "  Displayed here are some of the finest pieces of armor and protective trinkets you have laid eyes upon. They all either carry an enchantment or blessing from the %^MAGENTA%^Mistress of the Night%^RESET%^ or are preferred by her %^MAGENTA%^faithful, clergy and monks%^RESET%^ for their properties. Some of the objects seem rather familiar %^BOLD%^%^YELLOW%^- perhaps legendary -%^RESET%^ like the %^BOLD%^%^BLACK%^armor of pure ebony%^RESET%^ which sits on the shelf next to a %^MAGENTA%^violet robe%^RESET%^ that seems almost ragged by time, yet retains a %^MAGENTA%^glow of importance%^RESET%^. As you turn to move on you finally notice there are several items that are not immediately obvious to the eye, like the %^BOLD%^%^BLACK%^jet black ring%^RESET%^ that appears to absorb the light and the %^BOLD%^%^BLACK%^black leather cloak%^RESET%^ which sometimes shifts like a %^BOLD%^%^BLACK%^shadow%^RESET%^. ",
        ({"weapon display"}) : "This cabinet contains a large array of weapons - all well polished and cared for. It has been divided in equal parts, the higher one displaying the blunt weapons and the lower the sharp ones. Your eye is caught immediately by a very %^BOLD%^%^BLACK%^dark mace%^RESET%^ standing upright next to a %^BOLD%^%^BLACK%^chakram%^RESET%^ that seems to rouse images of the %^BLUE%^night%^RESET%^ when being looked upon. The sharp weapons start with the small blades, among which a peculiar %^BOLD%^%^BLACK%^wh%^RESET%^%^RED%^i%^RESET%^%^BOLD%^%^BLACK%^p-d%^RESET%^%^RED%^a%^RESET%^%^BOLD%^%^BLACK%^gg%^RESET%^%^RED%^e%^RESET%^%^BOLD%^%^BLACK%^r%^RESET%^ has a prominent position. Underneath it, amongst the larger blades, a %^BOLD%^%^BLACK%^sh%^RESET%^%^WHITE%^a%^RESET%^%^BOLD%^%^BLACK%^dowy%^RESET%^, %^BOLD%^%^BLACK%^d%^RESET%^%^WHITE%^u%^RESET%^%^BOLD%^%^BLACK%^ll%^RESET%^ %^BOLD%^%^WHITE%^s%^RESET%^%^WHITE%^i%^RESET%^%^BOLD%^%^BLACK%^lv%^RESET%^%^WHITE%^e%^RESET%^%^BOLD%^%^WHITE%^r%^RESET%^ short-sword lies flat on the shelf below a %^BOLD%^%^WHITE%^s%^RESET%^%^WHITE%^c%^RESET%^%^BOLD%^%^BLACK%^imit%^RESET%^%^WHITE%^a%^RESET%^%^BOLD%^%^WHITE%^r%^RESET%^ with a %^BLUE%^bejeweled%^RESET%^ hilt.",
    ...
    set_exits(([
        "west" : "/d/magic/temples/ashra/ashra",
    ]));
}
