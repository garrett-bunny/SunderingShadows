...
void chest_solved()
{
  write("The chest spits an object and a piece of paper at you, and then crumbles to dust before "
	"your eyes.");
  new("/d/hm_quest/obj/scabb2.c")->move(environment(TO));
  new("/d/hm_quest/obj/note5b.c")->move(environment(TO));
...
void write_wheel(int ansi)
{
  ...
  write("%^BOLD%^The root tops the trunk on this backward thing,\n"
        "That grows in the winter and dies in the spring.\n");
