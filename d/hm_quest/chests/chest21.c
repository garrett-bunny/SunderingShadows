...
void chest_solved()
{
  write("The chest spits an object and a piece of paper at you, and then crumbles to dust before "
	"your eyes.");
  new("/d/hm_quest/obj/blade3.c")->move(environment(TO));
  new("/d/hm_quest/obj/note4c.c")->move(environment(TO));
...
void write_wheel(int ansi)
{
  ...
  write("%^BOLD%^What is always in front of you\n"
        "but cannot be seen?\n"
        );
