...
void chest_solved()
{
  write("The chest spits an object and a piece of paper at you, and then crumbles to dust before "
	"your eyes.");
  new("/d/hm_quest/obj/scabb3.c")->move(environment(TO));
  new("/d/hm_quest/obj/note5c.c")->move(environment(TO));
...
void write_wheel(int ansi)
{
  ...
  write("%^BOLD%^I walked and walked and at last I got it;\n"
