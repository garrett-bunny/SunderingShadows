...
void create()
{
  ...
  set_long("At first glance, it would appear that it was a rusty chest, but "
	   "at closer inspection the chest is made of rust colored wood. It's "
	   "details just as sharp, and clear as it was new. There is no "
...
void write_wheel(int ansi)
{
  ...
  write("There is a little inscription on the plaque, and a set of rolling "
   ...
   write("%^BOLD%^A leathery snake, with stinging bite,\n"
