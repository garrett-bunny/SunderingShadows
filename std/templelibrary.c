#include <std.h>
#include <daemons.h>
//just a very generic temple library inherit
//should we add some default settings so that like say the 
//enemies of this diety cannot use the library or something?  Saide
inherit LIBRARY;
