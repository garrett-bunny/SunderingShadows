...
string *restricted_classes(string subrace) {
  if(!subrace || subrace == "") return ({ "bard", "paladin", "mage", "magus", "psion", "psywarrior", "monk", "druid", "warlock", "inquisitor" });
  switch(subrace) {
  case "tanarukk": return ({ "bard",  "paladin", "mage", "magus", "psion", "psywarrior", "monk", "druid","inquisitor" }); break;
     default: return ({ "bard",  "paladin", "mage", "magus",  "psion", "psywarrior", "monk", "druid", "warlock", "inquisitor" }); break;
   }
}
