...
mapping query_class_spells()
{
    return(([
        ...
        4 : ({"cause critical wounds","cure critical wounds","glyph of warding","hold monster","magic vestments","meld into nature","neutralize poison","prevent stealing","protection from stealing","sanctify","snakebite","sticks into snakes" }),
