...
void create()
{
    ...
    feat_desc("This Meta Magic feat will cause your next spell to behave as though it were one spell level higher. This feat is not available to psionic classes. This feat has a long cooldown");
    set_required_for(({ }));
}
