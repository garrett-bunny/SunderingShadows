...
void create()
{
    ...
    feat_desc("You learn to use your weapon better. The critical multiplier of any weapon you wield will be increased by 1. In addition, you can't be disarmed by the Disarm feat.
