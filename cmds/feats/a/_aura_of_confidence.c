...
void create() {
    ...
    feat_desc("Through sheer grit the warrior can push through fear, inspiring others to do the same. Parties of the fighter will gain 50% bonus to resist fear effects.");
    permanent(1);
    set_required_for(({}));
}
