...
void create()
{
    ...
    feat_desc("A shadow adept gains ability to store spells in his shadow, more reliable than an archmage, gaining additional four spell slots per level. In addition to that, he will gain some shadow themed innate spells:
