...
void create()
{
    ...
    set_description("This spell allows you to reconstruct past events that occurred in your current location based on the tracks and other signs left behind. Your ability to discern tracks will depend on your power.");
    set_verbal_comp();
    set_somatic_comp();
    set_helpful_spell(1);
}
