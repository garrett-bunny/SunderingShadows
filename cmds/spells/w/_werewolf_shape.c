...
void create()
{
    ...
    set_description("With this power, a werewolf can transform itself into a huge wolf, or into a humanoid wolf-like being. The wolf form acts much like a common wolf in combat, with powerful specials. The hybrid form looks a lot like the original humanoid form, with wolf-like ears and soft fur. Both forms provide bonuses to physical attributes, armor class, sight, attack, damage, perception, and survival. The Lycanthropy weakness to silver is also intesified.
