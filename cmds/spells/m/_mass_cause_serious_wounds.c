...
void create() {
    ...
    set_description("This is a stronger version of the priest spell, cause serious wounds.  When cast on a target, it will do damage to them if they are living, and it will heal them if they are undead.");
    set_verbal_comp();
    set_somatic_comp();
    set_non_living_ok(1);
}
