...
void create() {
    ...
    set_description("This will create a globe of darkness which will overcome normal light sources. This globe is more powerful than the darkness spell. You may only possess one globe of darkness at a time.");
    set_verbal_comp();
    set_non_living_ok(1);
    set_helpful_spell(1);
}
