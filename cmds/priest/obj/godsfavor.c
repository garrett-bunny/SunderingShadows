...
#define ACTIVETEMPLES ({ "jarmila","kreysneothosies","lord shadow","nimnavanon","lysara","callamir","nilith","kismet","ryorik","varda","the faceless one","cevahir","seija","khyron","ashra"})
object ob;
...
int now(string str){
    ...
    switch(lower_case(diety)){
        ...
        case "lysara":
            ...
            tell_room(room,"%^CYAN%^The %^BOLD%^%^MAGENTA%^aroma %^RESET%^%^CYAN%^of %^BOLD%^%^MAGENTA%^li%^RED%^l%^MAGENTA%^i%^RED%^e%^MAGENTA%^s %^RESET%^%^CYAN%^fills the %^BOLD%^air%^RESET%^%^CYAN%^, and you can hear a %^BOLD%^%^BLACK%^bell %^RESET%^%^CYAN%^begin to toll, as a %^BOLD%^%^WHITE%^mist %^RESET%^%^CYAN%^begins to form behind "+playername+". A faint outline of %^BOLD%^%^BLACK%^g%^RESET%^r%^BOLD%^%^BLACK%^av%^RESET%^e%^BOLD%^%^BLACK%^st%^RESET%^o%^BOLD%^%^BLACK%^n%^RESET%^e%^BOLD%^%^BLACK%^s %^RESET%^%^CYAN%^and %^BOLD%^%^BLACK%^m%^RESET%^%^CYAN%^a%^BOLD%^%^BLACK%^u%^RESET%^%^CYAN%^s%^BOLD%^%^BLACK%^o%^RESET%^%^CYAN%^l%^BOLD%^%^BLACK%^e%^RESET%^%^CYAN%^u%^BOLD%^%^BLACK%^m%^RESET%^%^CYAN%^s can be seen within the %^BOLD%^%^WHITE%^mist %^RESET%^%^CYAN%^as it begins to %^BOLD%^wrap %^RESET%^%^CYAN%^around "+playername+", pulling him into it.",player);
